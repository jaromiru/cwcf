...
data_train.to_pickle(str(data_path / "cifar-train"))
data_val.to_pickle(str(data_path / "cifar-val"))
data_test.to_pickle(str(data_path / "cifar-test"))
...
meta.to_pickle(str(data_path / "cifar-meta"))
