...
# ---
def get_data(train):
    data_raw = datasets.MNIST(
        "../data/dl/",
        train=train,
        download=True,
        transform=transforms.Compose(
            [transforms.ToTensor(), lambda x: x.numpy().flatten()]
        ),
        target_transform=lambda y: y.numpy(),
    )
...
data_train.to_pickle("../data/mnist-train")
data_val.to_pickle("../data/mnist-val")
data_test.to_pickle("../data/mnist-test")
...
meta.to_pickle("../data/mnist-meta")
