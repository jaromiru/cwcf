...
# binarize
label_0 = data.iloc[:, -1] < 3
label_1 = ~label_0

data.loc[label_0, 54] = 0
data.loc[label_1, 54] = 1
...
data_train.to_pickle("../data/forest-2-train")
data_val.to_pickle("../data/forest-2-val")
data_test.to_pickle("../data/forest-2-test")
...
print(meta)
meta.to_pickle("../data/forest-2-meta")